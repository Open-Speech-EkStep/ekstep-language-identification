import unittest
from inference import evaluation, create_output, load_yaml_file
...
class TestEvaluation(unittest.TestCase):
    ...
    def test__file_with_no_sound_should_be_classified_as_vocal(self):
        self.assertEqual(evaluation('Unit_testing_files/Vocal_test_set/Malayalam/Malayalam_1_chunk_1.wav', self.model_path),
                         dict({'confidence_score': {'vocal': '0.97222', 'songs': '0.02778'}}))

    def test__file_with_loud_music_only_should_be_classified_as_song(self):
        self.assertEqual(evaluation('Unit_testing_files/Songs_test_set/Punjabi/Punjabi_1_chunk_1.wav', self.model_path),
                         dict({'confidence_score': {'vocal': '0.00013', 'songs': '0.99987'}}))

    def test__file_with_laughing_sound_should_be_classified_as_song(self):
        self.assertEqual(evaluation('Unit_testing_files/Songs_test_set/Punjabi/Punjabi_2_chunk_37.wav', self.model_path),
                         dict({'confidence_score': {'vocal': '0.13867', 'songs': '0.86133'}}))

    def test__file_having_vocals_only_should_be_classified_as_vocal(self):
        self.assertEqual(evaluation('Unit_testing_files/Vocal_test_set/English/English_4_chunk_43.wav', self.model_path),
    ...
    def test__file_having_more_music_than_vocals_sound_should_be_classified_as_song(self):
        self.assertEqual(evaluation('Unit_testing_files/Songs_test_set/English/English_5_chunk_1.wav', self.model_path),
    ...
    def test__file_with_loud_music_and_vocals_should_be_classified_as_song(self):
        self.assertEqual(evaluation('Unit_testing_files/Songs_test_set/Punjabi/Punjabi_1_chunk_3.wav', self.model_path),
    ...
    def test__file_in_which_several_people_are_shouting_should_be_classified_as_song(self):
        self.assertEqual(evaluation('Unit_testing_files/Noisy_test_set/Debate/Debate_1_chunk_117.wav', self.model_path),
    ...
    def test__file_in_which_crowd_is_clapping_and_shouting_should_be_classified_as_song(self):
        self.assertEqual(evaluation('Unit_testing_files/Noisy_test_set/Noise/Noise_3_chunk_5.wav', self.model_path),
...
class TestLoadYamlFile(unittest.TestCase):
    def test__loading_yaml_file_and_extracting_content_as_dictionary(self):
        self.assertEqual(load_yaml_file('Unit_testing_files/Dummy_language_map.yml'), dict({'languages': {0: 'others', 1: 'music'}}))
